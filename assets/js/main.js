...
function validateName() {
  ...
  if (!nameField.match(/^[A-Za-z]*\s{1}[A-Za-z]+$/)) {
    nameError.innerHTML = "enter character";
...
$("#submit-form").submit((e) => {
  ...
  if (
    ...
    $.ajax({
      url: "https://script.google.com/macros/s/AKfycbyjQRn9pz3oCUPCcA74WUxwaphDLa3Y0FFp2EW2OeGm-VabFMWuk-z93yiyFcti1Lq4rg/exec",
